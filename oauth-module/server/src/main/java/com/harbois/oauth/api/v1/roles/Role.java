package com.harbois.oauth.api.v1.roles;
...
import com.harbois.oauth.api.v1.common.domain.ClientIdentity;

@Entity(name="USER_ROLE")
public class Role extends AuditableEntity<Long> implements ClientIdentity{

	@Id
	@TableGenerator(name = "USER_ROLE_ID", table= "APP_ID_GEN", initialValue = 100, allocationSize = 10)
