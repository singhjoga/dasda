...
public class SshHelper {
	...
	public ExecResult execute(String command, boolean returnOutput, long maxExecutionTimeout,long inactivityTimeout) throws SshSessionlException {
		...
		try {
			...
			ExecResult result = execute(command, os, maxExecutionTimeout, inactivityTimeout);
			if (returnOutput) {
				String output = FileUtils.readFileToString(outFile, UTF8);
	...
	public ExecResult execute(String command, OutputStream out, long maxExecutionTimeout,long inactivityTimeout) throws SshSessionlException {
		OutputStream os = null;
	...
	public void extractFile(String remoteFilePath, String destDir) throws SshSessionlException{
		String command=null;
	...
	public String createTempDir() throws SshSessionlException{
		String dir = "/tmp/komrade_"+timestampFormat.format(new Date());
